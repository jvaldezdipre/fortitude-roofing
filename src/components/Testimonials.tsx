      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-white/80 max-w-2xl mx-auto">
            Don't just take our word for it. Hear from our satisfied customers about their experience with PeakRoof.
          </p>
        </div>
            ...
            >
              ...
              <div className="flex mb-4">
                {[...Array(5)].map((_, i) => (
                  <Star 
                    key={i} 
                    className={`h-4 w-4 mr-1 ${i < testimonial.rating ? 'text-roofing-teal fill-roofing-teal' : 'text-white/20'}`} 
                  />
                ))}
              </div>
        ...
        <div className="mt-16 text-center">
          <p className="text-xl font-medium mb-6">Our customers have rated us:</p>
          <div className="flex items-center justify-center mb-4">
            ...
            <span className="text-3xl font-bold ml-4">4.9</span>
          </div>
