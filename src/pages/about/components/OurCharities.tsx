      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-roofing-darkgray">
            Fortitude Roofing is on a mission to be MORE than just another
            Roofing Company. We feel it's imperative to impact our communities.
            As such, we have decided to partner with the following charities.
            The more we grow, the more we will give.
          </p>
        </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8 bg-white rounded-lg p-6">
            <div className="lg:w-1/2 flex flex-col justify-center order-2 lg:order-1">
              ...
              <div>
                <Button
                  variant="outline"
                  className="border-roofing-teal text-roofing-teal hover:bg-roofing-teal hover:text-white"
                >
                  Donate
                </Button>
              </div>
